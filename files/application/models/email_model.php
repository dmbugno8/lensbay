...
class Email_model extends CI_Model
{
    ...
    function order_creating_email_by_admin($order_status, $order_number, $product_ordered, $product_quantity, $email_to)
    {
        $system_url = base_url();
        ...
        $email_msg .= "Product: " . $product_ordered . "<br \>";
        $email_msg .= "Product quantity: " . $product_quantity . "<br \>";
    ...
    function order_creating_email_by_customer($email_from, $customer_name, $order_number, $product_ordered, $product_quantity, $order_status)
    {
        $system_url = base_url();
        $email_sub  = "New Order Created";
