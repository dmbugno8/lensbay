    ...
    <div class="col-md-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="<?php if ($page_name == 'admin') echo 'active';?>">
                <a href="<?php echo base_url();?>index.php?admin/message">Messaging</a>
            </li>
        </ol>
    </div>
</div>
                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        <a class="btn btn-block btn-primary compose-mail" 
                            href="<?php echo base_url();?>index.php?admin/message_new">
                                Compose New Message
                        </a>
                        ...
                        ?>
                            <li>
                                <a href="<?php echo base_url();?>index.php?admin/message_read/<?php echo $message_list_thread_code;?>"> 
        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <br>
                        <?php 
                            echo form_open(base_url() . 'index.php?admin/message_reply/' . $message_thread_code , array(
