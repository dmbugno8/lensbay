                ...
                <li class="<?php if ($page_name == 'customer') echo 'active';?>">
                    <a href="<?php echo base_url();?>index.php?admin/customer">
                        <i class="fa fa-users"></i> 
                            <span class="nav-label">ECPs</span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'supplier') echo 'active';?>">
                    <a href="<?php echo base_url();?>index.php?admin/supplier">
                        <i class="fa fa-truck"></i> 
                            <span class="nav-label">Manufactures</span>
                    </a>
                </li>
                ...
                <li class="<?php if ($page_name == 'product' ||
                    ...
                    <!-- MANAGE PRODUCTS -->
                        <li class="<?php if ($page_name == 'product') echo 'active';?>">
                            <a href="<?php echo base_url();?>index.php?admin/product">Lens Designs</a>
                        </li>
                    <!-- PRODUCT BARCODE -->
                    ...
                    <!-- CATEGORY -->
                        <li class="<?php if ($page_name == 'product_category') echo 'active';?>">
                            <a href="<?php echo base_url();?>index.php?admin/product_category">GP / SOFT "category"</a>
                        </li>
                    <!-- SUB CATEGORY -->
                    ...
                    <!-- MATERIAL SUB CATEGORY -->
                        <li class="<?php if ($page_name == 'material_sub_category') echo 'active';?>">
                            <a href="<?php echo base_url();?>index.php?admin/material_sub_category">Material</a>
                        </li>

                    <!-- MATERIAL MANUFACTURE CATEGORY -->
