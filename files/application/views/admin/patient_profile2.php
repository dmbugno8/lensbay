...
<div class="wrapper wrapper-content">
    <div class="row">
    <?php
        $patients   =   $this->db->get_where('patient' , array('patient_id' => $param2))->result_array();
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="ibox-content profile-content">
                        ...
                        <p>
                            <i class="fa fa-code-fork"></i> <?php echo $row['patient_code'];?> 
                        </p>
                        <br>
                        <p>
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tbody>
                                        <?php
                                            $orders_of_patient =   $this->db->get_where('order' , array('patient_id' => $param2))->result_array();
                                            foreach ($orders_of_patient as $row2):
                                        ?>
                                            <tr>
                                ...
                                <div id="tab-2" class="tab-pane">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tbody>
                                        <?php
                                            $payments =   $this->db->get_where('payment' , array('patient_id' => $row['patient_id']))->result_array();
                                            foreach ($payments as $row3):
                                        ?>
                                            <tr>
                                                <td>
                                                    <?php echo $this->db->get_where('invoice' , array('patient_id' => $row['patient_id']))->row()->invoice_code;?>
                                                </td>
                                                <td>
