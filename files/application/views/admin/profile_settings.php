                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" 
                            src="<?php echo base_url();?>uploads/admin_image/<?php echo $row['admin_id'];?>.jpg">
                    </div>
                ...
                <!-- PROFILE SETTINGS FORM -->
                    ...
                    <div>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                    <input type="email" placeholder="Admin email" class="form-control" name="email"
                                        value="<?php echo $row['email'];?>">
                            </div>

                            <div class="form-group">
                                <label>About me</label>
                                    <textarea type="text" placeholder="About Me" class="form-control" name="about"><?php echo $row['about'];?></textarea>
                            </div>
