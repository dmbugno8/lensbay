                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                                        ...
                                        <select data-placeholder="Select a customer" required 
                                            ...
                                            foreach ($customers as $row):?>
                                                <option value="<?php echo $row['customer_id'];?>">
                                                    [<?php echo $row['customer_code'];?> ] - <?php echo $row['name'];?>
                                                    </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                <label>Patient</label>
                                    <div class="input-group">
                                        <select data-placeholder="Select a patient" required 
                                            class="chosen-select" style="width: 458px;" tabindex="2" name="patient_id">
                                            <option value=""></option>
                                            <?php
                                            ...
                                            foreach ($patient as $row):?>
                                                <option value="<?php echo $row['patient_id'];?>">
                                                    [<?php echo $row['patient_code'];?> ] - <?php echo $row['last_name'];?> - <?php		echo $row['customer_id']	?>
                                                    </option>
                                            <?php endforeach;?>
                                        </select>
                                    </div>
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <select data-placeholder="Select a category" onchange="get_product('supplier' , this.value)" 
                            class="chosen-select" style="width: 240px;" tabindex="2" name="supplier_id">
                            <option value=""></option>
                            <?php
