                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <address>
                                ...
                                <?php
									echo $this->db->get_where('settings' , array('type' => 'name'))->row()->description;"<br>"
									echo $this->db->get_where('settings' , array('type' => 'ship_to_street'))->row()->description"<br>";
									echo $this->db->get_where('settings' , array('type' => 'ship_to_city'))->row()->description;", "
									echo $this->db->get_where('settings' , array('type' => 'ship_to_state'))->row()->description;
									echo $this->db->get_where('settings' , array('type' => 'ship_to_zip'))->row()->description;
								?>
                                <br>
                                <?php
