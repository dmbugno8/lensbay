...
<div class="row" style=" margin:100px 0px 200px;">
	...
	<div class="col-md-6" style="text-align:center;">
    	<img src="<?php echo  $this->crud_model->get_image_url('customer' , $this->session->userdata('user_id'));?>" 
