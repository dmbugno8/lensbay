            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        ?>
                            <li>
                                <a href="<?php echo base_url();?>index.php?employee/message_read/<?php echo $message_list_thread_code;?>"> 
        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <br>
                        <?php 
                            echo form_open(base_url() . 'index.php?employee/message_reply/' . $message_thread_code , array(
