    ...
    <div class="col-md-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="<?php if ($page_name == 'profile_settings') echo 'active';?>">
                <a href="<?php echo base_url();?>index.php?employee/profile_settings">Profile</a>
            </li>
        </ol>
    </div>
</div>
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" 
                            src="<?php echo base_url();?>uploads/employee_image/<?php echo $row['employee_id'];?>.jpg">
                    </div>
            ...
            <div class="ibox float-e-margins">
                ...
                <!-- PROFILE SETTINGS FORM -->
                    ...
                    <div>
                        ...
                        <?php 
                            echo form_open(base_url() . 'index.php?employee/profile_settings/update/' , array(
            ...
            <div class="ibox float-e-margins">
                ...
                <?php foreach($employee as $row): ?>
                    <div>
                        ...
                        <?php 
                            echo form_open(base_url() . 'index.php?employee/profile_settings/change_password/' , array(
                                'enctype' => 'multipart/form-data'
                            ));
                        ?>
