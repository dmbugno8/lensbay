<?php
	$update = $this->db->get_where('customer' , array('customer_id' => $param2))->result_array();
?>

<div class="col-sm-12"><h3 class="m-t-none m-b">Edit <?php echo $this->db->get_where('customer' , array('customer_id' => $param2))->row()->name;?></h3>
		...
		<div class="form-group">
	    	<label>Customer Code</label>
	    		<input type="text" class="form-control" name="customer_code" readonly=""
	    			value="<?php echo $row['customer_code'];?>" required>
	    </div>	    
