    ...
    <div class="col-lg-8">
        ...
        <ol class="breadcrumb">
            ...
            <li class="<?php if ($page_name == 'purchase_history') echo 'active';?>">
                <a href="<?php echo base_url();?>index.php?patient/purchase_history">Purchase History</a>
            </li>
            <li class="<?php if ($page_name == 'invoice_view') echo 'active';?>">
                <a href="<?php echo base_url();?>index.php?patient/invoice_view">View Invoice</a>
            </li>
        </ol>
     </div>
    <div class="col-lg-4">
            ...
            <div class="ibox-content p-xl">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <address>
                                <strong>
                                	<?php echo $this->db->get_where('patient',array('patient_id'=>$row['patient_id']))
															->row()->name;?>
                                </strong><br>
                                	<?php echo $this->db->get_where('patient',array('patient_id'=>$row['patient_id']))
															->row()->address;?><br>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <?php echo $this->db->get_where('patient' , array('patient_id' => $row2['patient_id']))->row()->name;?> </td>
                                </tr>
